            ...
            {kanji.map((kanji, index) => {
              ...
              return (
                ...
                >
                  {/* Card face 1 */}
                  <div
                    className={` items-center flex justify-center rounded-3xl bg-eel flex-col mx-2 relative transition-all duration-1000 [transform-style:preserve-3d]`}
                    ...
                    {/* // Card face 2 */}
                    <div className={` ${flipped[index] ? '' : 'hidden'} inset-0 rounded-3xl bg-eel [transform:rotateY(180deg)] [backface-visibility:hidden] w-full h-full pb-10`}>
                        ...
                        <div className="flex flex-col justify-start w-full">
                          ...
                          <div className="flex flex-row w-full ">
                            <div className="flex justify-start items-start">
                              <span className="pl-10 text-primary text-[18px]">
                                {kanji.kun}
                              </span>
                            </div>
                          </div>
                      ...
                      {/* top */}
                      <div className="flex absolute bottom-12 right-2">
                        <div className="flex flex-col">
                                    ...
                                    : name == 'genki'
                                      ...
                                      : name == 'mina'
                                        ...
                                        : name == 'wanikani'
                                          ? 'bg-pur'
                                          : 'bg-accent'}
                               w-8 h-8 bg-opacity-10 mr-1 items-center flex justify-center rounded-full cursor-pointer transition duration-1000 ease-in-out opacity ${sel == false? '' : 'opacity-50'}`}>
                              <div className={`
                                 ${name == 'testSet'
                                  ? 'bg-accent'
                                  : name == 'radicals'
                                    ...
                                    : name == 'genki'
                                      ...
                                      : name == 'mina'
                                        ...
                                        : name == 'wanikani'
                                          ? 'bg-pur'
                                          : 'bg-accent'}
                                 w-5 h-5 rounded-full items-center flex justify-center transition duration-1000 ease-in-out opacity`} >
